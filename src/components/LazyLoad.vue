<script>
import { AdvancedImage, lazyload } from '@cloudinary/vue3';
...
// Instantiate a CloudinaryImage object for the image with the public ID, 'flowers'.
const myImg = cld.image('flowers');
