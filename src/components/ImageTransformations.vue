...
<template>
  <div class="App-body">
    <h3>Apply a thumbnail crop with rounded corners, as shown in<br><a class="App-link" href="https://cloudinary.com/documentation/vue_image_transformations#image_transformations_with_vue_js" target="_blank">Image transformations with Vue.js</a></h3>
