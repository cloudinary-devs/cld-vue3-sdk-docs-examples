...
<template>
  <div class="App-body">
    <h3>Focus on faces in a video, as shown in <br><a class="App-link" href="https://cloudinary.com/documentation/vue_video_transformations#video_transformations_with_vue_js" target="_blank">Video transformations with Vue.js</a></h3>
