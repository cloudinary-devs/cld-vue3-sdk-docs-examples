...
<template>
  <div class="App-body">
    <h3>Apply a range of transformations, as shown in the<br><a class="App-link" href="https://cloudinary.com/documentation/vue_integration#full_example" target="_blank">Full Example</a></h3>
